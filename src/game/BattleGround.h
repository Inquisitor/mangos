...
class BattleGround
{
    ...
    public:
        ...
        void SetArenaTeamMMRChangeForTeam(Team team, int32 MMRChange) { m_ArenaTeamMMRChanges[GetTeamIndex(team)] = MMRChange; }
        int32 GetArenaTeamMMRChangeForTeam(Team team) const    { return m_ArenaTeamMMRChanges[GetTeamIndex(team)]; }
    ...
    private:
        ...
        int32 m_ArenaTeamMMRChanges[PVP_TEAM_COUNT];
