...
enum BG_IC_Sounds
{
    BG_IC_SOUND_FLAG_CLAIMED            = 8192,
    BG_IC_SOUND_FLAG_CAPTURED_ALLIANCE  = 8173,
    BG_IC_SOUND_FLAG_CAPTURED_HORDE     = 8213,
    BG_IC_SOUND_FLAG_ASSAULTED_ALLIANCE = 8212,
    BG_IC_SOUND_FLAG_ASSAULTED_HORDE    = 8174,
    BG_IC_SOUND_FLAG_VICTORY            = 8456
};
...
{
    IC_EVENT_ADD_SPIR = 0,
    IC_EVENT_ADD_SPIR_HORDE_BASE,
    IC_EVENT_ADD_SPIR_WORKSHOP,
    IC_EVENT_ADD_SPIR_HANGAR,
    IC_EVENT_ADD_SPIR_ALLY_BASE,
    IC_EVENT_ADD_SPIR_DOCKS,
};
...
class BattleGroundIC : public BattleGround
{
    ...
    public:
        ...
        virtual void EventPlayerDamageGO(Player* /*plr*/, GameObject* go, uint8 hitType, uint32 destroyedEvent);
    ...
    private:
        ...
        void HandlePlayerUseTeleport(Player *user, GameObject *teleport);
